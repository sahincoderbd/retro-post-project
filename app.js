...
//    console.log(post);
      ...
      <div class="post-single hidden flex flex-col lg:flex-row gap-5">
        ...
        <!-- post content -->
         ...
         <h3 class="text-xl lg:text-2xl text-black font-semibold">${post.title}</h3>
        ...
        <div class="flex justify-between mt-3 gap-3">
          <div class="flex justify-between lg:justify-start gap-3">
            ...
            <span class="text-gray-700 text-lg">${post.view_count}</span>
            </div>
            <!-- published time -->
            <div class="flex gap-2 items-center">
            <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="flex gap-2 items-center self-end cursor-pointer">
            <button onClick = "sideBarPostHandler(${post.id})" class="flex gap-2 items-center cursor-pointer markAsRead">
...
const sideBarPostHandler=(postId)=>{
   ...
   const markAsReadAreas=postContainer.getElementsByClassName('markAsRead');
   const markAsReadCount=document.getElementById('markAsReadCount');
   // the main container
   const rightSideBar=document.getElementById('rightSideBar');
   const markAsReadArray=[];
